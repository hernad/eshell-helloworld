...
const DEFAULT_DOWNLOAD_HOST = 'https://bintray.com/bringout';
...
export class BinaryFetcher {
	...
	private _parseFolderPath(folderPath: string): {platform: string, revision: string} {
	...
	async localRevisions(): Promise<string[]> {
		...
		return fileNames
			.map((fileName) => this._parseFolderPath(fileName))
